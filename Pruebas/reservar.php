...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container-fluid">
            <img src="../Img/LogoBarberMexico.png" alt="" width="65">
    ...
    <script>
        ...
        const DURACION_SERVICIO = <?= preg_replace('/[^0-9]/', '', $servicioInfo['TimpoServicio']) ?>;
    </script>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            fetch("../API/api_horarios_servicio.php")
                .then(res => res.json())
                .then(horarios => {
                    ...
                    var calendar = new FullCalendar.Calendar(calendarEl, {
                        ...
                        selectable: true,
                        allDaySlot: false,
                        nowIndicator: true, // ⭐ Línea roja hora actual
                        expandRows: true,
                        height: "auto",
                        ...
                        // ⭐ Intervalos visuales
                        slotDuration: "00:" + INTERVALO_BASE + ":00",

                        // ⭐ Formato Booksy horas
                        slotLabelContent: function(arg) {

                            let hora = arg.date.toLocaleTimeString('en-US', {
                                hour: 'numeric',
                                minute: '2-digit'
                            });
                            ...
                            return {
                                html: "<span class='hora-booksy'>" + hora + "</span>"
                            };
                        },
                        ...
                        businessHours: horarios.business,
                        hiddenDays: horarios.hidden,
                        ...
                        events: function(fetchInfo, successCallback) {
                            ...
                            fetch(`../API/api_disponibilidad.php?servicio=${ID_SERVICIO}`)
                                .then(res => res.json())
                                .then(data => {
                        ...
                        selectAllow: function(selectInfo) {
                            ...
                            let inicio = selectInfo.start;
                            let finServicio = new Date(inicio.getTime() + DURACION_SERVICIO * 60000);

                            let eventos = calendar.getEvents();

                            for (let e of eventos) {
                                if (inicio < e.end && finServicio > e.start) {
                                    return false;
                                }
                            }
                        ...
                        select: function(info) {
                            ...
                            document.getElementById('fechaSeleccionada').innerText =
                                fechaStr + " (" + DURACION_SERVICIO + " min)";
